...
public class BoardBuilder {
    ...
    public static Board newGameBoard() {
        ...
        board.setPieceInPosition(2, 1, new Piece(PieceType.BISHOP, PieceColor.WHITE));
        board.setPieceInPosition(7, 1, new Piece(PieceType.BISHOP, PieceColor.WHITE));
        board.setPieceInPosition(2, 8, new Piece(PieceType.BISHOP, PieceColor.BLACK));
        board.setPieceInPosition(7, 8, new Piece(PieceType.BISHOP, PieceColor.BLACK));
        board.setPieceInPosition(3, 1, new Piece(PieceType.KNIGHT, PieceColor.WHITE));
        board.setPieceInPosition(6, 1, new Piece(PieceType.KNIGHT, PieceColor.WHITE));
        board.setPieceInPosition(3, 8, new Piece(PieceType.KNIGHT, PieceColor.BLACK));
        board.setPieceInPosition(6, 8, new Piece(PieceType.KNIGHT, PieceColor.BLACK));
